...
<br>Розберемо модель ***Word2vec*** на основі датасету російськомовних Twitter-постів. Для початку ми підготуємо цей датасет, який складається з твітів з позитивними та негативними відтінками, зібраною Ю.Рубцовою. Насамперед, потрібно скачати корпус позитивних та негативних твітів в форматі .csv, які знаходяться в цьому репозиторії за лінком  (positive.csv та negative.csv відповідно) та імпортувати відповідні бібліотеки:</br>
