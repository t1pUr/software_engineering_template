...
<br>Розберемо модель ***Word2vec*** на основі датасету російськомовних Twitter-постів. Для початку ми підготуємо цей датасет, який складається з твітів з позитивними та негативними відтінками, зібраною Ю.Рубцовою. Насамперед, потрібно скачати корпус позитивних та негативних твітів в форматі .csv (positive.csv та negative.csv відповідно) та імпортувати відповідні бібліотеки:</br>
...
<br>Обидва файли мають безліч стовпців, такі як ім'я автора поста, дата публікації і т.д., але нас цікавить тільки самі twitter-пости, також нас не цікавить позитивні ці твіти або негативни, тому ми просто об'єднаємо їх</br>
...
```
<br>Цей код знаходиться у мене в репозиторії за лінком: </br>
